...
export default function Settings() {
  ...
  const updateUser = (e) => {
    ...
    axios.put(`${Apis.bookingApis.update}${user._id}`, user)
    .then(response => {
      setTimeout(()=>{
        ...
        <FormContainer onSubmit={updateUser} style={{ flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap' }}>
          ...
          <ThirdPart>
            <DataColumn>
              ...
              <Button type='button' variant='text' size='small' color='primary' onClick={(e) => { e.preventDefault(); requestPasswordReset(); }}>Request Password Reset</Button>
            </DataColumn>
          </ThirdPart>
        </FormContainer>
